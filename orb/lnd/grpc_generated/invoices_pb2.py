...
_CANCELINVOICEMSG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="payment_hash",
            full_name="invoicesrpc.CancelInvoiceMsg.payment_hash",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_ADDHOLDINVOICEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="memo",
            full_name="invoicesrpc.AddHoldInvoiceRequest.memo",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="hash",
            full_name="invoicesrpc.AddHoldInvoiceRequest.hash",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="invoicesrpc.AddHoldInvoiceRequest.value",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="value_msat",
            full_name="invoicesrpc.AddHoldInvoiceRequest.value_msat",
            index=3,
            number=10,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="invoicesrpc.AddHoldInvoiceRequest.description_hash",
            index=4,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="expiry",
            full_name="invoicesrpc.AddHoldInvoiceRequest.expiry",
            index=5,
            number=5,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="fallback_addr",
            full_name="invoicesrpc.AddHoldInvoiceRequest.fallback_addr",
            index=6,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="cltv_expiry",
            full_name="invoicesrpc.AddHoldInvoiceRequest.cltv_expiry",
            index=7,
            number=7,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="route_hints",
            full_name="invoicesrpc.AddHoldInvoiceRequest.route_hints",
            index=8,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="private",
            full_name="invoicesrpc.AddHoldInvoiceRequest.private",
            index=9,
            number=9,
            type=8,
            cpp_type=7,
...
_ADDHOLDINVOICERESP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="invoicesrpc.AddHoldInvoiceResp.payment_request",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="add_index",
            full_name="invoicesrpc.AddHoldInvoiceResp.add_index",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="payment_addr",
            full_name="invoicesrpc.AddHoldInvoiceResp.payment_addr",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
_SETTLEINVOICEMSG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="preimage",
            full_name="invoicesrpc.SettleInvoiceMsg.preimage",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_SUBSCRIBESINGLEINVOICEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="r_hash",
            full_name="invoicesrpc.SubscribeSingleInvoiceRequest.r_hash",
            index=0,
            number=2,
            type=12,
            cpp_type=9,
...
CancelInvoiceMsg = _reflection.GeneratedProtocolMessageType(
    "CancelInvoiceMsg",
    (_message.Message,),
    {
...
CancelInvoiceResp = _reflection.GeneratedProtocolMessageType(
    "CancelInvoiceResp",
    (_message.Message,),
    {
...
AddHoldInvoiceRequest = _reflection.GeneratedProtocolMessageType(
...
AddHoldInvoiceResp = _reflection.GeneratedProtocolMessageType(
    "AddHoldInvoiceResp",
    (_message.Message,),
    {
...
SettleInvoiceMsg = _reflection.GeneratedProtocolMessageType(
    "SettleInvoiceMsg",
    (_message.Message,),
    {
...
SettleInvoiceResp = _reflection.GeneratedProtocolMessageType(
    "SettleInvoiceResp",
    (_message.Message,),
    {
...
SubscribeSingleInvoiceRequest = _reflection.GeneratedProtocolMessageType(
    "SubscribeSingleInvoiceRequest",
    (_message.Message,),
    {
