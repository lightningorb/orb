<script>
    ...
    $: key = versions != null && radioGroup != '' ? versions.builds[latest].filter((x) => x[0] == radioGroup)[0][1] : null;

    $: files = versions != null && latest != null ? versions.builds[latest] : [];
    $: dl_url = `${url}${files[radioGroup]}`;
    $: all_done = radioGroup !== '';
    // let raw_invoice = urlParams.get('raw_invoice');
    // let rand_id = urlParams.get('rand_id') || '';
            ...
            <Container>
                ...
                <Row class="justify-content-center">
                    <Col lg={{size: 3}} class="text-white text-center">
                        ...
                        <img style='width: 100px' src='https://lnorb.s3.us-east-2.amazonaws.com/images/android.png'/>
                        </a>
                    </Col>
                    <Col lg={{size: 3}} class="text-white text-center">
                        <a href='https://testflight.apple.com/join/i8wfm9TH'>
                        <img style='width: 50px;  position: relative; top: 8px;' src='https://lnorb.s3.us-east-2.amazonaws.com/images/testflight.png'/>
                        </a>
                ...
                {#if versions}
                    ...
                    <Row>
                        <Col class='text-white mt-5' lg={{size: 8, offset: 2}}>
                            <p>Once your download is complete, please read our <a href='https://lnorb.com/docs/installing.html'>installation documentation</a>.</p>
                        </Col>
                    </Row>
                {/if}
            </Container>
